        ...
        <div className="container mx-auto px-4 md:px-6 py-12 max-w-2xl">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Please review the details below before confirming your stay.</CardDescription>
                </CardHeader>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">{bookingDetails.dates.from} to {bookingDetails.dates.to}</p>
                            </div>
                        </div>
                         <div className="flex items-center gap-2">
